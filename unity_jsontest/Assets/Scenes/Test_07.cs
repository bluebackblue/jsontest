...
public class Test_07
{
	...
	*/
	public static bool Check(System.Collections.Generic.Dictionary<string,int> a_from,System.Collections.Generic.Dictionary<string,int> a_to)
	{
		...
		t_result &= Test.Check_Dictionary("",a_from,a_to,(string a_a_label,int a_a_index,in int a_a_from,in int a_a_to) => {
	...
	/** 更新。
	*/
	public static void Main(string a_label = nameof(Test_07))
	{
