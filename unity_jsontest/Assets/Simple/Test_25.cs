	...
	public class Test_25
	{
		...
		*/
		public static bool Check(Item a_from,Item a_to)
		{
			...
			//dictionary_type
			t_result &= Simple.Check_Dictionary("dictionary_type",a_from.dictionary_type,a_to.dictionary_type,(string a_a_llabel,int a_a_index,in Type a_a_from,in Type a_a_to) => {
				bool t_t_result = true;	
				t_t_result &= Simple.Check_Enum(a_a_llabel,a_a_from,a_a_to);
				return t_t_result;
			});

			//list_item
			t_result &= Simple.Check_Enumerator("list_item",a_from.list_item,a_to.list_item,(string a_a_label,int a_a_index,in Item_Type a_a_from,in Item_Type a_a_to) => {
				bool t_t_result = true;	
				t_t_result &= Simple.Check_Enum(a_a_label,a_a_from.value_type,a_a_to.value_type);
				return t_t_result;
			});

			//dictionary_item
			t_result &= Simple.Check_Dictionary("dictionary_item",a_from.dictionary_item,a_to.dictionary_item,(string a_a_llabel,int a_a_index,in Item_Type a_a_from,in Item_Type a_a_to) => {
				bool t_t_result = true;	
				t_t_result &= Simple.Check_Enum(a_a_llabel,a_a_from.value_type,a_a_to.value_type);
				return t_t_result;
			});
		...
		/** 更新。
		*/
		public static void Main(string a_label = nameof(Test_25))
		{
