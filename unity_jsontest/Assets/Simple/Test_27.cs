		...
		*/
		public static bool Check(Item a_from,Item a_to)
		{
			...
			Simple.Check_Enumerator("arraylist",a_from.arraylist,a_to.arraylist,(string a_a_label,int a_a_index,in System.Object a_a_from,in System.Object a_a_to) => {
				...
				case 5:
					{
						t_t_result &= Simple.Check_Dictionary("5",(System.Collections.Generic.Dictionary<string,int>)a_a_from,(System.Collections.Generic.Dictionary<string,System.Object>)a_a_to,(string a_a_a_label,int a_a_a_index,in int a_a_a_from,in System.Object a_a_a_to) => {
							bool t_t_t_result = true;
							t_t_t_result &= Simple.Check_Int(a_a_a_label,(int)a_a_a_from,(int)(ulong)a_a_a_to);
							return t_t_t_result;
						});
				...
				case 6:
					{
						t_t_result &= Simple.Check_Enumerator("6",(int[])a_a_from,(System.Collections.Generic.List<System.Object>)a_a_to,(string a_a_a_label,int a_a_a_index,in int a_a_a_from,in System.Object a_a_a_to) => {
							bool t_t_t_result = true;
							t_t_t_result &= Simple.Check_Int(a_a_a_label,(int)a_a_a_from,(int)(ulong)a_a_a_to);
							return t_t_t_result;
						});
